"""
Django settings for mutougeda_cn project.
...
INSTALLED_APPS = [
    ...
    'app_mysite_01.apps.AppMysite01Config',
    'ckeditor',
    'ckeditor_uploader',
    'sorl.thumbnail',
]
...
ROOT_URLCONF = 'mutougeda_cn.urls'
...
WSGI_APPLICATION = 'mutougeda_cn.wsgi.application'
