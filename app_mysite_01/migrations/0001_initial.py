# Generated by Django 2.0.2 on 2018-06-07 17:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_mysite_01.Category', verbose_name='类别')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(blank=True, help_text='标签数量控制在四个以内', to='app_mysite_01.Tag', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='app_mysite_01.Post', verbose_name='评论所属文章'),
        ),
    ]
